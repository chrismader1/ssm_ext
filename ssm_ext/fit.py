...
def fit_rSLDS_restricted_em(y, params, C=None, d=None, n_iter_em=10, seed=None,
    ...
    ANTI-COLLAPSE GUARDRAILS (pre-declared, principled, frozen before scoring):
      ...
      4. stickiness  - StickyRecurrentOnly gate (kappa=sticky_kappa) biases
    ...
    # Swap the gate for the sticky variant carrying kappa on ALL classes
    # (Fox 2011 stickiness). sticky_kappa=None => keep the plain gate (no stickiness):
...
def fit_SLDS_restricted_em(y, params, C=None, d=None, n_iter_em=10, seed=None,
    ...
    (sticky_kappa). The ONLY difference is the transition form: a fixed K x K matrix
